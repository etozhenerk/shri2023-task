function Header(){let[e,t]=React.useState(!1),[l,n]=React.useState(!1),o=()=>{l||n(!0),t(!e)};return<header className="header">
        ...
        </header>}function Event(e){let t=React.useRef(),{onSize:l}=e;return React.useEffect(()=>{let e=t.current.offsetWidth,n=t.current.offsetHeight;l&&l({width:e,height:n})}),<li ref={t}className={"event"+(e.slim?" event_slim":"")}>
            ...
            <section className="section main__scripts">
                ...
                <ul className="event-grid">
                    ...
                    <Event slim={!0}icon="temp2"iconLabel="Температура"title="Набрать горячую ванну"subtitle="Начнётся в 18:00"/>
            ...
            <section className="section main__devices">
                ...
                <div className="section__title">
                    ...
                    <select className="section__select"defaultValue="all"onInput={s}>
                        ...
                        {TABS_KEYS.map(e=><option key={e}value={e}>
                    ...
                    <ul role="tablist"className="section__tabs">
                        ...
                        {TABS_KEYS.map(e=><li key={e}role="tab"aria-selected={e===l?"true":"false"}tabIndex={e===l?"0":void 0}className={"section__tab"+(e===l?" section__tab_active":"")}id={`tab_${e}`}aria-controls={`panel_${e}`}onClick={()=>n(e)}>
                ...
                <div className="section__panel-wrapper"ref={e}>
                    ...
                    {TABS_KEYS.map(e=><div key={e}role="tabpanel"className={"section__panel"+(e===l?"":" section__panel_hidden")}aria-hidden={e===l?"false":"true"}id={`panel_${e}`}aria-labelledby={`tab_${e}`}>

                            <ul className="section__panel-list">

                                {TABS[e].items.map((e,t)=><Event key={t}{...e}onSize={h}/>)}
        ...
        </main>}setTimeout(()=>{let e=ReactDOM.createRoot(document.getElementById("app"));e.render(<>
